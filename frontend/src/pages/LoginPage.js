  ...
  const handleGoogleLogin = async () => {
    ...
    setTimeout(() => {
      const googleUser = {
        ...
        email: 'doctor.google@medical-ai.org',
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-8" data-testid="login-container">
          ...
          <Button
            ...
            disabled={loading || googleLoading}
            variant="outline"
            className="w-full border-slate-200 hover:bg-slate-50 py-5 transition-colors duration-200 flex items-center justify-center space-x-2"
          >
            {googleLoading ? (
